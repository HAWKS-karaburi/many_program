...
class BrainDeadGenerator:
    ...
    def _build_word_pack(self) -> WordPack:
        ...
        pack.adjectives = self._generate_words(
            ...
            ["형", "성", "적", "화", "기반", "구조", "인프라", "솔루션", "프레임워크", "플랫폼", "엔진", "모델", "네트워크", "시스템", "로직", "아키텍처", "파이프라인", "오케스트레이션", "큐레이션", "루프", "접점", "센터"],
        )
        pack.nouns = self._generate_words(
            ...
            ["화", "성", "체", "축", "망", "센터", "포인트", "공간", "레벨", "인프라", "노드", "라이프", "스코프", "파라미터", "필터", "스토리지", "리포지토리", "모듈", "클래스", "카탈로그", "디자인", "메신저"],
        )
        ...
        pack.daily_terms = self._generate_words(
            ...
            ["팩", "박스", "칩", "볼", "통", "덩어리", "세트", "봉지", "포장", "상자", "조각", "모음", "한입", "리미트", "라인", "로드", "플랜", "클럽", "코너", "버전"],
        )
        pack.tech_terms = self._generate_words(
            ...
            ["엔진", "서버", "모듈", "스택", "랩", "클러스터", "프레임", "코어", "네트워크", "API", "SDK", "플랫폼", "오브젝트", "러너", "서비스", "파이프", "시뮬레이터", "프로토콜", "드라이버", "아키텍처", "인프라"],
        )
        pack.startup_terms = self._generate_words(
            ...
            ["랩", "클럽", "네트워크", "오큘러스", "코어", "포인트", "파이프", "허브", "플랫폼", "스페이스", "센터", "플로우", "스토리", "모델", "엔진", "서비스", "아이디어", "인사이트", "워크플로", "솔루션", "데이터"],
        )
        pack.government_terms = self._generate_words(
            ...
            ["사업", "프로그램", "체계", "정책", "플랫폼", "개발", "지원", "연계", "구축", "분석", "모델", "로드맵", "지원체계", "협력체계", "위원회", "심의체", "혁신단", "국책", "연구단", "추진단"],
        )
